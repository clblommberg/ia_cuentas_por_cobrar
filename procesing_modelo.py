...
working_dir = "C:/Users/Valerio/Documents/programming/FINANCIAL_DEVELOPMENT/accountant_receivable/"

df_mayor = pd.read_excel(working_dir+ "data.xlsx", sheet_name="lmayor")
df_clients = pd.read_excel(working_dir+ "data.xlsx", sheet_name="clients")
df_sales = pd.read_excel(working_dir+ "data.xlsx", sheet_name="sales")
df_enterprise= pd.read_excel(working_dir+ "data.xlsx", sheet_name="enterprise")
